...
function FileBlock({ mediaUrl, settings }: { mediaUrl: string; settings?: ContentBlockSettings }) {
  return (
    ...
    >
      ...
      <span className="px-4 py-2 rounded-lg bg-white/5 text-sm font-medium group-hover:bg-primary group-hover:text-white transition-all flex items-center gap-2">
